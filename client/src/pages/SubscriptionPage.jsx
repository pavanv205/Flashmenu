...
export default function SubscriptionPage() {
  ...
  const handleVerifyBypass2FA = async (e) => {
    ...
    try {
      setBypassLoading(true);
      const res = await authAPI.verifyMasterBypassOTP({
      ...
      if (res.data?.restaurant) {
        updateRestaurantState(res.data.restaurant);
      }
      setBypassSuccess('Account Activated with Zero Fees! Reloading status...');
      setTimeout(() => {
        ...
        <div className="text-center py-6 animate-fade-in space-y-4">
          ...
          <div className="flex items-center justify-center space-x-4 pt-6 max-w-2xl mx-auto">
            ...
            <span
              ...
              className="text-xs font-extrabold text-gray-400 uppercase tracking-widest px-3 cursor-pointer select-none"
