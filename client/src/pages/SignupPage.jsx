            ...
            >
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 rounded-2xl bg-dark-card border border-dark-border divide-x divide-dark-border overflow-hidden">
                  <div className="p-3 text-center space-y-1">
                    ...
                    <span className="text-xl font-black text-white block">₹3,499</span>
                    <span className="text-[10px] text-gray-500 font-semibold block">Valid for 6 Months</span>
                  </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                <button
                  type="button"
                  onClick={() =>
                    handleOpenDemoPayment('basic', 'Basic Restaurant (6 Months)', '6 Months Access', 3499)
                  }
                ...
                >
                  ...
                  <span>Pay 6 Months (₹3,499)</span>
                </button>

                <button
                  type="button"
                  onClick={() =>
                    handleOpenDemoPayment('basic', 'Basic Restaurant (Lifetime)', 'Lifetime One-Time', 9999)
                  }
