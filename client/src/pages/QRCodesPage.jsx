...
import { QrCode, Download, Printer, Table, ExternalLink } from 'lucide-react';
...
export default function QRCodesPage() {
  ...
  const targetUrl = selectedTable
    ? `${baseUrl}/menu/${restaurant.slug}?table=${selectedTable}`
  ...
  const handleDownloadPNG = () => {
    ...
    img.onload = () => {
      ...
      if (ctx) {
        ...
        downloadLink.download = `${restaurant.slug}-qr-table-${selectedTable || 'master'}.png`;
