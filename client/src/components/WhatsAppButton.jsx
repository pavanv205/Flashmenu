    ...
    >
      ...
      <div className="relative group">
        <a
          ...
          className="w-14 h-14 rounded-full bg-[#25D366] hover:bg-[#20bd5a] text-white flex items-center justify-center shadow-2xl shadow-[#25D366]/40 hover:scale-110 active:scale-95 transition-all duration-300 relative"
        ...
        <div
          className={`absolute bottom-full right-0 mb-3 whitespace-nowrap bg-zinc-900 border border-white/10 text-white text-xs font-bold px-3.5 py-2 rounded-xl shadow-xl transition-all duration-300 pointer-events-none ${
        ...
        >
          ...
          {/* Tooltip Tail Arrow */}
          <div className="absolute top-full right-5 w-2.5 h-2.5 bg-zinc-900 border-r border-b border-white/10 rotate-45 -mt-1" />
        </div>
      </div>
    </div>
  );
